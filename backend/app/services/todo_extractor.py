...
4. 如果文本中某个待办没有指定负责人，且**任务描述中也没有提到任何其他人名**，而「{user_name}」是发言者或会议组织者，才视为分配给自己
5. **任务描述中提到其他人名作为执行者的，属于他人任务，完全忽略**。例如"安排杨湘帮助部署"是杨湘的任务而非「{user_name}」的任务；"让张三跟进"是张三的任务。即使没有明确标注"负责人"，只要能从上下文判断出实际执行者是其他人，就不要提取
